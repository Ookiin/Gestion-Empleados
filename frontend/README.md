...
const handleUpdateEmployee = (employeeId: string, newFirstName: string, newPosition: string) => {
// Lógica para manejar la actualización del empleado.
};
...
Copiar
Editar
export const updateUser = async (token: string, userId: string, updateData: any) => {
const response = await fetch(`/api/employees/${userId}`, {
method: "PUT",
headers: {
Authorization: `Bearer ${token}`,
